...
const invoiceSchema = new mongoose.Schema({
  ...
  taxRate: { type: Number, default: 0 }, taxAmountOriginal: { type: Number, default: 0 },
  taxAmountBase: { type: Number, default: 0 },
  status: { type: String, enum: ['draft','issued','paid','overdue','cancelled','unpaid','partially_paid'], default: 'draft' },
  paidAmountBase: { type: Number, default: 0 }, remainingAmountBase: { type: Number, default: 0 },
...
const Invoice: Model<any> = (mongoose.models.Invoice as Model<any>) || mongoose.model<any>('Invoice', invoiceSchema)
